...
contains
   ...
   subroutine Vector_grad_vec(u1, u2, u3, u4, u5, u6, u7, u8, co_arr)
      implicit none

      real(8), intent(in) :: u1, u2, u3, u4, u5, u6, u7, u8  
      real(8), dimension(24), intent(out) :: co_arr
      !$omp declare target
   ...
   subroutine Vector_grad_planes(a1, a2, a3, a4, a5, a6, a7, a8, &
     ...
     !$omp declare target
      ...
      tmp_arr(1) = a4a1 * b2b1 - b4b1 * a2a1
      tmp_arr(2) = a5a1 * b4b1 - b5b1 * a4a1
      tmp_arr(3) = a2a1 * b5b1 - b2b1 * a5a1
      ...
      tmp_arr(4) = a1a2 * b3b2 - b1b2 * a3a2
      tmp_arr(5) = a6a2 * b1b2 - b6b2 * a1a2
      tmp_arr(6) = a3a2 * b6b2 - b3b2 * a6a2
      ...
      tmp_arr(7) = a2a3 * b4b3 - b2b3 * a4a3
      tmp_arr(8) = a7a3 * b2b3 - b7b3 * a2a3
      tmp_arr(9) = a4a3 * b7b3 - b4b3 * a7a3
      ...
      tmp_arr(10) = a3a4 * b1b4 - b3b4 * a1a4
      tmp_arr(11) = a8a4 * b3b4 - b8b4 * a3a4
      tmp_arr(12) = a1a4 * b8b4 - b1b4 * a8a4
      ...
      tmp_arr(13) = a6a5 * b8b5 - b6b5 * a8a5
      tmp_arr(14) = a1a5 * b6b5 - b1b5 * a6a5
      tmp_arr(15) = a8a5 * b1b5 - b8b5 * a1a5
      ...
      tmp_arr(16) = a7a6 * b5b6 - b7b6 * a5a6
      tmp_arr(17) = a2a6 * b7b6 - b2b6 * a7a6
      tmp_arr(18) = a5a6 * b2b6 - b5b6 * a2a6
      ...
      tmp_arr(19) = a8a7 * b6b7 - b8b7 * a6a7
      tmp_arr(20) = a3a7 * b8b7 - b3b7 * a8a7
      tmp_arr(21) = a6a7 * b3b7 - b6b7 * a3a7
      ...
      tmp_arr(22) = a5a8 * b7b8 - b5b8 * a7a8
      tmp_arr(23) = a4a8 * b5b8 - b4b8 * a5a8
      tmp_arr(24) = a7a8 * b4b8 - b7b8 * a4a8
